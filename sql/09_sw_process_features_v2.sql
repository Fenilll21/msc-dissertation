...
transfers_prefix AS (
    ...
    INNER JOIN first_sw fi ON t.hadm_id = fi.hadm_id
...
INNER JOIN first_sw fi ON a.hadm_id = fi.hadm_id
LEFT JOIN process_features pf ON a.hadm_id = pf.hadm_id
)
TO 'C:/Users/Lenovo/Desktop/Msc Project/data/features/sw_process_features_v2.csv'
WITH CSV HEADER;